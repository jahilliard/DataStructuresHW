 ...
 * 
 * 	TreeDisplay Class, uses TreeNode Class
 * 	Do not modify this class. You can ignore all of the code below.
 * 	Specifically, DO NOT USE THIS CLASS IN YOUR SOLUTION TO THIS HOMEWORK!
 */
...
public class TreeDisplay<E> extends JComponent
{
	...
	{
		this.root = root;
		repaint(); //signal that the display needs to be redrawn
	}
